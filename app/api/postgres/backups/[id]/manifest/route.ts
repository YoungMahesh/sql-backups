...
/**
 * GET /api/postgres/backups/[id]/manifest
 *
 * Returns the Backup Manifest sibling JSON for the requested PostgreSQL Database Backup,
...
export async function GET(_req: Request, context: RouteContext) {
  try {
    ...
    console.error("Failed to fetch PostgreSQL backup manifest:", err);
    const message =
