...
/**
 * GET /api/postgres/backups/[id]/download
 * Returns a pre-signed S3 download URL for the requested PostgreSQL backup.
 */
export async function GET(_req: Request, context: RouteContext) {
  try {
    ...
    console.error("Failed to generate PostgreSQL backup download URL:", err);
    const message =
