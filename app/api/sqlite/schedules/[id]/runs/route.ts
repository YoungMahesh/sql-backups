...
/**
 * GET /api/sqlite/schedules/[id]/runs
 * Returns recent Backup Run rows for the given SQLite schedule, newest first.
 */
export async function GET(req: Request, context: RouteContext) {
  try {
    ...
    const message =
      err instanceof Error ? err.message : "Failed to fetch SQLite runs.";
