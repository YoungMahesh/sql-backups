        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b border-zinc-100 pb-5">
          ...
          <div className="flex items-center gap-2 self-start sm:self-auto">
            <button
              ...
              disabled={isLoading}
              className="flex items-center gap-1.5 rounded-xl border border-zinc-200 bg-white px-3.5 py-2 text-xs font-semibold text-zinc-700 shadow-2xs transition hover:bg-zinc-50 disabled:opacity-50"
            >
              <svg
            ...
            <button
              ...
              className="flex items-center gap-1.5 rounded-xl bg-zinc-900 px-3.5 py-2 text-xs font-semibold text-white shadow-sm transition hover:bg-zinc-800 disabled:opacity-50"
            >
        ...
        <div className="mt-6">
          {isLoading && schedules.length === 0 ? (
            ...
            <div className="rounded-xl border border-dashed border-zinc-200 py-12 text-center">
              ...
              <p className="mt-3 text-sm font-semibold text-zinc-800">No schedules yet</p>
